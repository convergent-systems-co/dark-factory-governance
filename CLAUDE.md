...
- **Panels** (`governance/personas/panels/`) — 18 multi-persona review workflows. Panels coordinate personas and emit structured JSON conforming to `governance/schemas/panel-output.schema.json`.
