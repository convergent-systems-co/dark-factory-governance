...
- Write a detailed implementation plan to `.plans/` before writing infrastructure code
...
<!-- AGENT_MSG_START -->
{
  ...
  "payload": {
    "summary": "Implemented infrastructure for X per plan .plans/{N}-description.md",
