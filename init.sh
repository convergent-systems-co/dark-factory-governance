...
print('#')
print('# NOTE: The Dark Factory governance workflow approves PRs as github-actions[bot].')
print('# Bot approvals do NOT satisfy code owner review requirements. See')
print('# .ai/governance/docs/repository-configuration.md for workarounds.')
print()
