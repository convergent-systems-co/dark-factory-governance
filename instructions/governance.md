...
- **Plan-first is still mandatory** — Write a plan to `.governance/plans/` (consuming repos) or `governance/plans/` (Dark Factory Governance repo) before any implementation.
